  ...
  // (ĐƯỢC ĐƯA LÊN TRƯỚC BƯỚC NGÂN HÀNG ĐIỆN TỬ THEO YÊU CẦU MỚI)
  {
    ...
    sections: [
      ...
      },
      {
        ...
        scope: 'khtc',
        fields: [
          { key: 'D3_HO_TEN',       label: 'Họ và tên',         type: 'text',  required: true, scope: 'khtc' },
          { key: 'D3_CHUC_VU',      label: 'Chức vụ',           type: 'text',  required: true, scope: 'khtc', placeholder: 'Kế toán trưởng...' },
          { key: 'D3_NGAY_SINH',    label: 'Ngày tháng năm sinh', type: 'date', required: true, scope: 'khtc', placeholder: 'dd/mm/yyyy' },
          { key: 'D3_QUOC_TICH',    label: 'Quốc tịch',         type: 'text',  required: true, scope: 'khtc', placeholder: 'Mặc định: Việt Nam' },
          { key: 'D3_CCCD_SO',      label: 'Số CCCD / Hộ chiếu', type: 'text', required: true, scope: 'khtc' },
          { key: 'D3_CCCD_NGAY_CAP', label: 'Ngày cấp',         type: 'date',  required: true, scope: 'khtc', placeholder: 'dd/mm/yyyy' },
          { key: 'D3_CCCD_HET_HAN', label: 'Có giá trị đến',    type: 'date',  required: true, scope: 'khtc', placeholder: 'dd/mm/yyyy' },
          { key: 'D3_CCCD_NOI_CAP', label: 'Nơi cấp',           type: 'select', required: true, scope: 'khtc', options: NOI_CAP_CCCD_OPTIONS },
          { key: 'D3_SDT',          label: 'Số điện thoại',      type: 'tel',   required: true, scope: 'khtc' },
          { key: 'D3_EMAIL',        label: 'Email',               type: 'email', required: true, scope: 'khtc' },
          { key: 'D3_DC_THUONG_TRU', label: 'Địa chỉ thường trú', type: 'textarea', required: true, scope: 'khtc' },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        scope: 'both',
        fields: [
          { key: 'USER1_HO_TEN',       label: 'Họ và tên',         type: 'text',  required: true,  scope: 'both' },
          { key: 'USER1_CCCD_SO',      label: 'Số CCCD / Hộ chiếu', type: 'text',  required: true,  scope: 'both', placeholder: '012xxxxxxxxx' },
          { key: 'USER1_CCCD_NGAY_CAP', label: 'Ngày cấp',         type: 'date',  required: true,  scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER1_CCCD_HET_HAN', label: 'Có giá trị đến',    type: 'date',  required: true,  scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER1_CCCD_NOI_CAP', label: 'Nơi cấp',           type: 'select', required: true,  scope: 'both', options: NOI_CAP_CCCD_OPTIONS },
          { key: 'USER1_QUOC_TICH',    label: 'Quốc tịch',         type: 'text',  required: true,  scope: 'both', placeholder: 'Mặc định: Việt Nam' },
          { key: 'USER1_SDT',          label: 'Số điện thoại',      type: 'tel',   required: true,  scope: 'both' },
          { key: 'USER1_EMAIL',        label: 'Email',               type: 'email', required: true,  scope: 'both' },
        ],
      },
      {
        id: 'user2',
        ...
        scope: 'both',
        fields: [
          { key: 'USER2_HO_TEN',       label: 'Họ và tên',         type: 'text',  required: true, scope: 'both' },
          { key: 'USER2_CCCD_SO',      label: 'Số CCCD / Hộ chiếu', type: 'text',  required: true, scope: 'both' },
          { key: 'USER2_CCCD_NGAY_CAP', label: 'Ngày cấp',         type: 'date',  required: true, scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER2_CCCD_HET_HAN', label: 'Có giá trị đến',    type: 'date',  required: true, scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER2_CCCD_NOI_CAP', label: 'Nơi cấp',           type: 'select', required: true, scope: 'both', options: NOI_CAP_CCCD_OPTIONS },
          { key: 'USER2_QUOC_TICH',    label: 'Quốc tịch',         type: 'text',  required: true, scope: 'both', placeholder: 'Mặc định: Việt Nam' },
          { key: 'USER2_SDT',          label: 'Số điện thoại',      type: 'tel',   required: true, scope: 'both' },
          { key: 'USER2_EMAIL',        label: 'Email',               type: 'email', required: true, scope: 'both' },
        ],
      },
      {
        id: 'user3',
        ...
        scope: 'both',
        fields: [
          { key: 'USER3_HO_TEN',       label: 'Họ và tên',         type: 'text',  required: true, scope: 'both' },
          { key: 'USER3_CCCD_SO',      label: 'Số CCCD / Hộ chiếu', type: 'text',  required: true, scope: 'both' },
          { key: 'USER3_CCCD_NGAY_CAP', label: 'Ngày cấp',         type: 'date',  required: true, scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER3_CCCD_HET_HAN', label: 'Có giá trị đến',    type: 'date',  required: true, scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER3_CCCD_NOI_CAP', label: 'Nơi cấp',           type: 'select', required: true, scope: 'both', options: NOI_CAP_CCCD_OPTIONS },
          { key: 'USER3_QUOC_TICH',    label: 'Quốc tịch',         type: 'text',  required: true, scope: 'both', placeholder: 'Mặc định: Việt Nam' },
          { key: 'USER3_SDT',          label: 'Số điện thoại',      type: 'tel',   required: true, scope: 'both' },
          { key: 'USER3_EMAIL',        label: 'Email',               type: 'email', required: true, scope: 'both' },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        scope: 'both',
        fields: [
          { key: 'TEN_TO_CHUC_VI',      label: 'Tên tổ chức',           type: 'text',     required: true,  scope: 'both' },
          { key: 'SO_GIAY_TO_PHAP_LY',  label: 'Số giấy tờ pháp lý',   type: 'text',     required: true,  scope: 'both' },
          { key: 'DIA_CHI_GIAO_DICH',   label: 'Địa chỉ giao dịch',     type: 'textarea', required: true,  scope: 'both' },
          { key: 'NDDPL_HO_TEN',        label: 'Người đại diện pháp luật — Họ và tên', type: 'text', required: true, scope: 'both' },
          { key: 'NDDPL_CHUC_VU',       label: 'Chức vụ',               type: 'text',     required: true,  scope: 'both' },
          { key: 'NDDPL_QUOC_TICH',     label: 'Quốc tịch',             type: 'text',     required: true,  scope: 'both', placeholder: 'Mặc định: Việt Nam' },
          { key: 'NDDPL_CCCD_SO',       label: 'Số CCCD / Hộ chiếu',    type: 'text',     required: true,  scope: 'both' },
          { key: 'NDDPL_CCCD_NGAY_CAP', label: 'Ngày cấp',              type: 'date',     required: true,  scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'NDDPL_CCCD_HET_HAN',  label: 'Có giá trị đến ngày',   type: 'date',     required: true,  scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'NDDPL_CCCD_NOI_CAP',  label: 'Nơi cấp',               type: 'select',   required: true,  scope: 'both', options: NOI_CAP_CCCD_OPTIONS },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          { key: 'USER1_HO_TEN',       label: 'Họ và tên',          type: 'text',  required: true,  scope: 'both' },
          { key: 'USER1_CCCD_SO',      label: 'Số CCCD / Hộ chiếu', type: 'text',  required: true,  scope: 'both' },
          { key: 'USER1_CCCD_NGAY_CAP', label: 'Ngày cấp',          type: 'date',  required: true,  scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER1_CCCD_HET_HAN', label: 'Có giá trị đến',     type: 'date',  required: true,  scope: 'both', placeholder: 'dd/mm/yyyy' },
          { key: 'USER1_CCCD_NOI_CAP', label: 'Nơi cấp',            type: 'select', required: true,  scope: 'both', options: NOI_CAP_CCCD_OPTIONS },
          { key: 'USER1_QUOC_TICH',    label: 'Quốc tịch',          type: 'text',  required: true,  scope: 'both', placeholder: 'Mặc định: Việt Nam' },
